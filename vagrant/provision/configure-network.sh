...
send "/app/vagrant/config/genesis/flotea.json\n"
...
send "wallet.eth.devel\n"
expect "Where should data be stored on the remote machine?"
send "/home/vagrant/wallet\n"
...
send "{'address':'3e216b18e24c6cbe4c68e68b8c7bfebd664526c4','crypto':{'cipher':'aes-128-ctr','ciphertext':'0035a20edd15d2561aa46090ab6eb3bd3b631de84aaaafb948b8695eb711d7c2','cipherparams':{'iv':'b722bfc405e7898c7b81e1452cc83d31'},'kdf':'scrypt','kdfparams':{'dklen':32,'n':262144,'p':1,'r':8,'salt':'b4ee846183ee751fc91240d02f1a8f139957c27c6fd48b8dbae3dcdb162a6763'},'mac':'d828cf65444445ffe991ff43db03ff39b03ac8325297cee704ede66733ff21cb'},'id':'44d5ef7b-bde5-4aed-af6c-f187b79edeb8','version':3}\n"
